...
const ListUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get("https://apiunoigualados.up.railway.app/user/all", {
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://apiunoigualados.up.railway.app/user/${deleteUserId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleUpdateUser = async () => {
    try {
      await axios.put(
        `https://apiunoigualados.up.railway.app/user/${selectedUser.id}`,
